...
- [`references/windows-encoding.md`](references/windows-encoding.md) — when remote Windows output contains non-ASCII text (Chinese filenames, localized messages) or arrives garbled (乱码)
